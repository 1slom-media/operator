...
import { addCustomer } from "redux-store/admin/customers/customers.slice";
...
function AddCustomerModal({ handleSubmit, page }) {
  ...
  const handleAddCustomer = (values) => {
    ...
    dispatch(addCustomer({ values: data, token, alert, callBack, server }));
  };
        ...
        <Box sx={style}>
          ...
          <Stack>
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <Field component={TextInput} placeholder="Ism" name="name" />
              </Grid>
              <Grid item xs={12}>
                <Field
